...
export default function Main() {
  ...
  useLayoutEffect(() => {
    ...
    window.yaContextCb.push(() => {
      ...
      Ya.adfoxCode.create({
        ownerId: 1457688,
        containerId: "adfox_168000206557021788",
        params: {
          p1: "cxsvm",
          p2: "ieho",
          puid1: "",
    ...
    window.yaContextCb.push(() => {
      ...
      Ya.adfoxCode.create({
        ownerId: 1457688,
        containerId: "adfox_168000210322449790",
        params: {
          p1: "cxsxb",
          p2: "iehq",
          puid1: "",
      ...
      setTimeout(
        () =>
          (document.querySelector(
            ".banner-ht"
          ).children[0].children[0].style.width = "100vw"),
        500
      );
    }
    if (
    ...
    <>
      ...
      <div className="wrapper">
        ...
        >
          {layout === "mobile" && (
            <div style={{ display: "flex", justifyContent: "center" }}>
              <div id="adfox_167931708269983910"></div>
            </div>
          )}
          {layout === "tablet" && (
            <div style={{ display: "flex", justifyContent: "center" }}>
              <div id="adfox_16793172127941757"></div>
            </div>
          )}
          {layout === "desctop" && (
            <div style={{ display: "flex", justifyContent: "center" }}>
              <div id="adfox_167931750437195494"></div>
            </div>
          )}
        </div>
        <main
        ...
        >
          ...
          >
            <div id="adfox_168000206557021788"></div>
          </div>
          <div
            style={{
              width: "1280px",
          ...
          >
            ...
            <SliderBanner />
            <div style={{ display: "flex", justifyContent: "center" }}>
              <div id="adfox_167938911405652106"></div>
            </div>
            <Advantages />
            <Benefit />
            <Calculation />
          ...
          >
            <div id="adfox_168000210322449790"></div>
          </div>
        </main>
        <Footer />
      </div>
